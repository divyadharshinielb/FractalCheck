...
public class DeleteEventandClassroomPage extends FractalBasePage {
	...
	private By classroominstructorselect = By.xpath("//li[contains(text(),'automation direct user')]");
	...
	private By categoryoption = By.xpath("//div[@class='nice-select ng-pristine ng-untouched ng-isolate-scope ng-empty ng-invalid ng-invalid-required open']//li[@class='option'][contains(text(),'Technology')]");
