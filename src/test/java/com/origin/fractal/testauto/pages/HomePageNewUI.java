...
public class HomePageNewUI extends FractalBasePage {
	...
	private By termsLink = By.xpath(".//div/*/p/a[2]");//edited by dhanushiya .//div[contains(@class,'text-right col-lg-12 col-md-12 col-xs-12 col-sm-12')]/../div/p/a[2]
	...
	//	myLearning.verifyMyLearningLabels();
		...
		//dd commented because created a new account for mac	Actions actions = new Actions(driver); actions.moveToElement(element);
		//dd	actions.perform();
			wait(5);
			}
			...
			//commented because it is not required click(lblHome);
			wait(5);
			commonFunction();
			wait(5);
			click(termsLink);
