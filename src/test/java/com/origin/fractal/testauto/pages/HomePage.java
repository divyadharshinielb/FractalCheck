...
public class HomePage extends FractalBasePage {
  ...
  //for most popular filters//
    ...
    private By clickcourse = By.xpath("//h3[contains(text(),'Automation Checking course')]");
    private By loadMore = By.xpath(".//*[@id=\"ngview\"]/div[3]/ng-include/div/div/div[3]/div[2]/button");
   ...
   //************most popular************//
	...
	public void AccessCatalogItemEnrolledOutside() {
		...
		wait(5);
		click(loadMore);
		verifyLabel("lblEnrolledText",clickcourse);
		wait(5);
