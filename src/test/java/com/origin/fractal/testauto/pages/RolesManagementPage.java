...
public class RolesManagementPage extends FractalBasePage {
	...
	private By manageUser = By.xpath("//li[@title='Manage Users']//a");//li[@title='Manage Users']//a//span[contains(text(),'Manage Users')]
	    private By businessUser = By.xpath("//span[contains(text(),'Staging BusinessUser')]");
	    ...
	    private By siteAdmin = By.xpath("//span[contains(@class,'cursor-pointer version-bubble font-size-18 height_25 title_name text-capitalize ng-binding ng-scope')][contains(text(),'Site Admin')]");
