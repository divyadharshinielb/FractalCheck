...
public class WebTestsLogin extends FractalBaseWebTest {
	...
	@Test(dataProviderClass = DataManager.class, dataProvider = "browers", groups = {
			"Phase1.0" }, enabled = true, description = "Login Page")
	...
	public void testLoginInvalid(String row, String strBrowserName) {
		...
		Reporter.writeSummary(
				"TCID_071, Verify the login page with valid user name and invalid password, " + loginSteps.getResult());
	...
	@Test(dataProviderClass = DataManager.class, dataProvider = "browers", groups = {
			"Phase1.0" }, enabled = true, description = "TCID_71: verification of Forgot Password Page"
