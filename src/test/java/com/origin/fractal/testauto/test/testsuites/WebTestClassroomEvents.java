...
//		 new Object[] { "4", "ie11" }
	...
	public void verifyEvents(String row, String strBrowserName) throws IOException {
		...
		Reporter.writeSummary("TCID_001,  Verify Add new event page is opened on clicking the Ads Event button, " +  classSteps.getResult() );
		//TCID_01: Verify Add new event page is opened on clicking the Ads Event button
		classSteps.verifyAddEventPageOpened();
		Reporter.writeSummary("TCID_002,  Verify on clicking SAVE throws the alert for all mandatory fields, " +  classSteps.getResult() );
		//TCID_02: Verify on clicking SAVE, throws the alert for all mandatory fields
		classSteps.verifyAlertForAllFieldsInPage1();
		Reporter.writeSummary("TCID_003,  Verify whether the alert is thrown when Venue drop-down is not selected, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_29,  Verify on clicking SAVE throws the alert for all mandatory fields, " +  classSteps.getResult() );
	...
	//	classSteps.verifySelectClassroomTypeAlertMsg();
		...
		Reporter.writeSummary("TCID_04,  Verify whether the alert is thrown when Venue drop-down is not selected, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_05,  Verify whether the alert is thrown when Link drop-down is not selected, " +  classSteps.getResult() );
		//TCID_06: Verify whether the alert is thrown, when an Average score is not entered.
	/*	classSteps.verifyAverageScoreAlertMsg();
		//TCID_07: Verify whether the alert is thrown, when the Start Time is not entered under sessions
   */	classSteps.verifySessionStartTimeAlertMsg();
        Reporter.writeSummary("TCID_008,  Verify whether the alert is thrown when the End Time is not entered under sessions, " +  classSteps.getResult() );
		//TCID_08: Verify whether the alert is thrown, when the End Time is not entered under sessions
		classSteps.verifySessionEndTimeAlertMsg();
		Reporter.writeSummary("TCID_009,  Verify whether the alert is thrown when the Instructor drop-down is not selected under sessions, " +  classSteps.getResult() );
		//TCID_09: Verify whether the alert is thrown, when the Instructor drop-down is not selected under sessions
		classSteps.verifySelectInstrtuctorAlertMsg();
		Reporter.writeSummary("TCID_010,  Verify whether the error message is disappeared after Classroom selecting any of the classroom type, " +  classSteps.getResult() );
	...
	@Test(dataProvider = "browers", groups= {"pilot"}, enabled= true, 
 	...
 	public void verifyEvents1(String row, String strBrowserName) throws IOException {
		...
		//To click on a particular classroom item
		classSteps.clickOnClassroomItem();
		Reporter.writeSummary("TCID_011,  Verify whether the Venue drop-down is displayed after selecting Physical classroom, " +  classSteps.getResult() );
		//TCID_11: Verify whether the Venue drop-down is displayed after selecting Physical classroom
		classSteps.verifyPhysicalClassroomDropdown();
		Reporter.writeSummary("TCID_012,  Verify whether the Link drop-down is displayed after selecting Virtual classroom, " +  classSteps.getResult() );
		//TCID_12: Verify whether the Link drop-down is displayed after selecting Virtual classroom
		classSteps.verifyVirtualClassroomDropdown();
		Reporter.writeSummary("TCID_013,  Verify whether the Venue drop-down alert is disappeared after selecting any Venue , " +  classSteps.getResult() );
		//TCID_13: Verify whether the Venue drop-down alert is disappeared after selecting any Venue 
		classSteps.verifyVenueDropdownAlertDisappears();
		Reporter.writeSummary("TCID_014,  Verify whether the Link drop-down alert is disappeared after selecting any Link, " +  classSteps.getResult() );
		//TCID_14: Verify whether the Link drop-down alert is disappeared after selecting any Link 
		classSteps.verifyLinkDropdownAlertDisappears();
		Reporter.writeSummary("TCID_015,  Verify whether the show map check-box is displayed under Select Venue dropdown, " +  classSteps.getResult() );
		//TCID_15: Verify whether the show map check-box is displayed under Select Venue dropdown
...
//		classSteps.verifyShowmapCheckboxUnchecked();
		...
		Reporter.writeSummary("TCID_019,   Verify Whether the average score alert disappear after entering the score, " +  classSteps.getResult() );
		//TCID_19: Verify Whether the average score alert disappear after entering the score
/*	classSteps.verifyAvgScoreAlertDisappears();
	...
	*/	classSteps.closeLobjModel();
	...
	public void verifyEvents2(String row, String strBrowserName) throws IOException {
		...
		//To click on a particular classroom item
		classSteps.clickOnClassroomItem();
		Reporter.writeSummary("TCID_024,   Verify whether the Assignment details are displayed when clicking assignments label, " +  classSteps.getResult() );
		//TCID_24: Verify whether the Assignment details are displayed when clicking assignments label
		classSteps.verifyAssignDetailsDisplayed();
		Reporter.writeSummary("TCID_025,  Verify whether the assignment count maches with the number of assignments displayed, " +  classSteps.getResult() );
		//TCID_25: Verify whether the assignment count maches with the number of assignments displayed
		classSteps.verifyPreAssessmentCount();
		Reporter.writeSummary("TCID_026,   Verify whether the Add Assignment button is displayed after expanding Assignments, " +  classSteps.getResult() );
		//TCID_26: Verify whether the Add Assignment button is displayed after expanding Assignments
		classSteps.verifyAddAssignmentBtn();
		Reporter.writeSummary("TCID_027,  Verify whether the new assignment details fields are displayed after clicking the Add Assignment Button, " +  classSteps.getResult() );
		//TCID_27: Verify whether the new assignment details fields are displayed after clicking the Add Assignment Button
		classSteps.verifyNewPreAssignmentForm();
		Reporter.writeSummary("TCID_028,   Verify Whether the Add survey details are displayed after clicking Survey label, " +  classSteps.getResult() );
		//TCID_28: Verify Whether the Add survey details are displayed after clicking Survey label
		classSteps.verifySurveyDetailsDisplayed();
		Reporter.writeSummary("TCID_029,   Verify whether the Add Survey button is displayed after expanding Survey, " +  classSteps.getResult() );
		//TCID_29: Verify whether the Add Survey button is displayed after expanding Survey
		classSteps.verifyPreSurveyAddBtn();
		Reporter.writeSummary("TCID_030,   Verify whether the new Survey form details fields are displayed after clicking the Add Assignment Button, " +  classSteps.getResult() );
		//TCID_30: Verify whether the new Survey form details fields are displayed after clicking the Add Assignment Button
//		classSteps.verifyPreSurveyFormDetails();
		//TCID_31: Verify Whether the Session details are displayed after clicking Session label
		classSteps.verifySessionDetailsDisplayed();
		Reporter.writeSummary("TCID_032,   Verify whether the error message is displayed if the instructor name is not selected from drop-down, " +  classSteps.getResult() );
		//TCID_32: Verify whether the error message is displayed if the instructor name is not selected from drop-down
		classSteps.verifyInstructorDropdownAlertMsg();
		Reporter.writeSummary("TCID_033,   Verify whether the error message is disappeared after selecting any instructor from drop-down, " +  classSteps.getResult() );
		//TCID_33: Verify whether the error message is disappeared after selecting any instructor from drop-down
		classSteps.verifyInstructorDropdownAlertDisappears();
		//TCID_34: Verify whether the Assignment details are displayed when clicking Post event assignments label
		classSteps.verifyPostAssignmentDetails();
		Reporter.writeSummary("TCID_035,   Verify whether the post event assignment count matches with the number of assignments displayed, " +  classSteps.getResult() );
		//TCID_35: Verify whether the post event assignment count matches with the number of assignments displayed
		classSteps.verifyPostAssignmentCount();
		Reporter.writeSummary("TCID_036,  Verify whether the Add Assignment button is displayed after expanding Assignments under post event, " +  classSteps.getResult() );
		//TCID_36: Verify whether the Add Assignment button is displayed after expanding Assignments under post event
		classSteps.verifyPostAddAssignmentBtn();
		Reporter.writeSummary("TCID_037,  Verify whether the new assignment details fields are displayed after clicking the Add Assignment Button under post event, " +  classSteps.getResult() );
		//TCID_37: Verify whether the new assignment details fields are displayed after clicking the Add Assignment Button under post event
		classSteps.verifyPostAddAssignmentDetails();
		Reporter.writeSummary("TCID_038,  Verify Whether the Add survey details are displayed after clicking Survey label under post event, " +  classSteps.getResult() );
		//TCID_38: Verify Whether the Add survey details are displayed after clicking Survey label under post event
		classSteps.verifyPostSurveyDetails();
		Reporter.writeSummary("TCID_039,  Verify whether the Add Survey button is displayed after expanding Survey under post event, " +  classSteps.getResult() );
		//TCID_39: Verify whether the Add Survey button is displayed after expanding Survey under post event
		classSteps.verifyPostAddSurveyButton();
		Reporter.writeSummary("TCID_040,  Verify whether the new Survey form details fields are displayed after clicking the Add Assignment Button under post event, " +  classSteps.getResult() );
		//TCID_40: Verify whether the new Survey form details fields are displayed after clicking the Add Assignment Button under post event
//		classSteps.verifyPostAddSurveyFormFields();
	...
	public void verifyEvents3(String row, String strBrowserName) throws IOException {
		...
		classSteps.clickOnClassroomItem();
		Reporter.writeSummary("TCID_041, Verify Whether the Notifications days are displayed under Notifications & Reminders section, " +  classSteps.getResult() );
		//TCID_41: Verify Whether the Notifications days are displayed under "Notifications & Reminders" section
		classSteps.verifyNotifAndReminder();
		Reporter.writeSummary("TCID_042,  Verify whether the Notifications & Reminders fields accepts alphabets, " +  classSteps.getResult() );
		//TCID_42: Verify whether the "Notifications & Reminders" fields accepts alphabets
		classSteps.verifyNotifAndReminderFieldsAcceptsAlphabets();
		Reporter.writeSummary("TCID_043,   Verify whether the Notifications & Reminders fields accepts alpha numerics, " +  classSteps.getResult() );
		//TCID_43: Verify whether the "Notifications & Reminders" fields accepts alpha numerics
		classSteps.verifyNotifAndReminderFieldsAcceptsAlphaNumerics();
		Reporter.writeSummary("TCID_044,  Verify whether the  Notifications & Reminders fields accepts special charecters, " +  classSteps.getResult() );
		//TCID_44: Verify whether the "Notifications & Reminders" fields accepts special charecters
		classSteps.verifyNotifAndReminderFieldsAcceptsSpecialChars();
		Reporter.writeSummary("TCID_045,  Verify whether the Notifications & Reminders fields accepts numbers, " +  classSteps.getResult() );
		//TCID_45: Verify whether the "Notifications & Reminders" fields accepts numbers
		classSteps.verifyNotifAndReminderFieldsAcceptsNumbers();
		Reporter.writeSummary("TCID_046,   Verify whether the Reference Material Upload button is displayed, " +  classSteps.getResult() );
		//TCID_46: Verify whether the Reference Material Upload button is displayed
		classSteps.verifyReferenceUploadBtn();
		Reporter.writeSummary("TCID_047, Verify whether the Terms & Conditions are displayed at the end of the page, " +  classSteps.getResult() );
		//TCID_47: Verify whether the "Terms & Conditions" are displayed at the end of the page
		classSteps.verifyTermsConditions();
		Reporter.writeSummary("TCID_048,  Verify whether the 2nd page is opened on clicking continue button after filling all the mandatory fields, " +  classSteps.getResult() );
		//TCID_48: Verify whether the 2nd page is opened on clicking continue button after filling all the mandatory fields.
		...
		Reporter.writeSummary("TCID_050, Verify whether the Maximum no. of participants field accepts numbers, " +  classSteps.getResult() );
		//TCID_50: Verify whether the "Maximum no. of participants" field accepts numbers
	...
	public void verifyEvents4(String row, String strBrowserName) throws IOException {
		...
		wait(5);
		classSteps.verifyAddEventPageOpened();
		Reporter.writeSummary("TCID_051, Verify whether the Maximum no. of participants field accepts alphanumerics, " +  classSteps.getResult() );
		//TCID_51: Verify whether the "Maximum no. of participants" field accepts alphanumerics
    	classSteps.verifyMaxNumParticipAcceptAlphaNumeric();
    	Reporter.writeSummary("TCID_052,  Verify whether the Maximum no. of participants field accepts special characters, " +  classSteps.getResult() );
		//TCID_52: Verify whether the "Maximum no. of participants" field accepts special characters
		classSteps.verifyMaxNumParticipAcceptSpecialChars();
		Reporter.writeSummary("TCID_053,  Verify whether the Maximum no. of participants field accepts alphabets, " +  classSteps.getResult() );
		//TCID_53: Verify whether the "Maximum no. of participants" field accepts alphabets
		classSteps.verifyMaxNumParticipAcceptAlphabets();
		Reporter.writeSummary("TCID_054,  Verify whether the alert messgae is disappeared after entering Maximum no. of participants, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_074,  Verify whether the alert messgae is disappeared after entering Maximum no. of participants, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_055,  Verify whether the Minimum no. of participants field accepts numbers, " +  classSteps.getResult() );
		//TCID_55: Verify whether the "Minimum no. of participants" field accepts numbers
		classSteps.verifyMinNumParticipAcceptNum();
		Reporter.writeSummary("TCID_056,  Verify whether the Minimum no. of participants field accepts alphanumerics, " +  classSteps.getResult() );
		//TCID_56: Verify whether the "Minimum no. of participants" field accepts alphanumerics
		classSteps.verifyMinNumParticipAcceptAlphaNumeric();
		Reporter.writeSummary("TCID_057,  Verify whether the Minimum no. of participants field accepts special characters, " +  classSteps.getResult() );
		//TCID_57: Verify whether the "Minimum no. of participants" field accepts special characters
		classSteps.verifyMinNumParticipAcceptSpecialChars();
		Reporter.writeSummary("TCID_058,  Verify whether the Minimum no. of participants field accepts alphabets, " +  classSteps.getResult() );
		//TCID_58: Verify whether the "Minimum no. of participants" field accepts alphabets
		classSteps.verifyMinNumParticipAcceptAlphabets();
		Reporter.writeSummary("TCID_059,  Verify whether the alert message is disappeared after entering 'Minimum no. of participants', " +  classSteps.getResult() );
		//TCID_59: Verify whether the alert message is disappeared after entering 'Minimum no. of participants'
		classSteps.verifyMinNumParticipAlertDisappears();
		Reporter.writeSummary("TCID_060,  Verify whether the 'Waiting List Threshold' field accepts numbers, " +  classSteps.getResult() );
		//TCID_60: Verify whether the 'Waiting List Threshold' field accepts numbers
		classSteps.verifyMinNumParticipAlertDisappears();
        classSteps.verifyCancellationPolicy();
        Reporter.writeSummary("TCID_070,  Verify Whether the Cancellation Policy is displayed at the bottom of the page, " +  classSteps.getResult() );
	...
	public void verifyEvents5(String row, String strBrowserName) throws IOException {
		...
		wait(5);
		classSteps.verifyAddEventPageOpened();
		Reporter.writeSummary("TCID_20,  Verify whether the alert is disappearing after selection any value from the Select Instructor dropdown, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_19,  Verify whether the alert is disappearing after entering valid Duration, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_18,  Verify whether the alert is disappearing after entering valid Date, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_19, Verify whether the alert is disappearing after entering valid completion percentage, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_30, Verify whether the alert is disappearing after entering Maximum no. of participants, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_28, Verify whether the next page is loaded on clicking the continue button after entering all the mandatory form field, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_39,  Verify whether the alert is thrown when trying to save without adding minimum number of participants, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_40,  Verify whether the alert is thrown when trying to save after adding minimum number of participants, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_37,  Verify whether the admin able to add the users in the participants list, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_38, Verify whether the alert is thrown when trying to add the users in the participants list more than Maximum no. of participants, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_075,  Verify whether the participants are deleted from the participants list after clicking the delete icon, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_076,  Verify whether the participants are deleted from the Waiting List after clicking the delete icon, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_077,  Verify whether the Confirm button is displayed for all the participants in the waiting list, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_078,  Verify whether the Confirm button is removed for all the participants from the Waiting list after selecting the Auto update waiting list on cancellation radio button, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_066,  Verify Auto update waiting List on Cancellation radio button is working fine, " +  classSteps.getResult() );
		//TCID_66:Verify Auto update waiting List on Cancellation radio button is working fine
		classSteps.verifyParticipantsSearch();
		Reporter.writeSummary("TCID_080,  Verify whether the Select usere tab have Search box , " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_081,  Verify whether the search functionality is working fine, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_082,  Verify whether the Filtes All Enterprise and Direct user types are displayed below the Search box, " +  classSteps.getResult() );
		Reporter.writeSummary("TCID_083,  Verify whether the User type filters are working fine, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_45,  Verify whether the Publish Event button is disabled while creating, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_33,  Verify whether the alert is disappearing after selecting Start Date For Registration, " +  classSteps.getResult() );
		...
		Reporter.writeSummary("TCID_34,  Verify whether the alert is disappearing after selecting Last Date For Registration, " +  classSteps.getResult() );
