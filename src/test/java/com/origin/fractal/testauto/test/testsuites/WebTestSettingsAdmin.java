...
//		 new Object[] { "4", "ie11" }
	...
	@Test(dataProviderClass = DataManager.class, groups= {"pilot"}, enabled= true, description = "TCID_009:Dynamic payment configurations should appear in the User purchase page.")
