...
public class AndroidTestProd extends FractalBaseAppTest{
	...
	@Test(groups = { "pilot" },priority= 0, enabled = true, description = "TCID_01:Verification of Splash Screen"
		...
		//commenting as new user with fractal isntance is created. mASIS.selectFractal();
		wait(5);
		// My Learning Screen
	...
	@Test(groups = { "pilot" }, priority=3,enabled = true, description = "TCID_25:Verification of Menus page"
	...
	@Test(groups = { "pilot" },priority=5, enabled = true, description = "TCID_27,28,29,30,31,32,61:"
	...
	@Test(groups = { "pilot" },priority=2, enabled = true, description = "TCID_:Verification of My Account page"
