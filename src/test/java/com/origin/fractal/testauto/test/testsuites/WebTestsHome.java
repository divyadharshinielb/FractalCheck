...
*/   	//TCID_13:Verification of View all page labels
	...
	//	homeSteps.verifyBellNotification();//newui
		...
		Reporter.writeSummary("TCID_HOME_070, Verify whether All the Notifications are getting listed on clicking the More tab, " + homeSteps.getResult() ); 
...
*/		//TCID_80:Verify the function of  Wish list icon
	...
	//	Reporter.writeSummary("TCID_HOME_042,  Verify The data should be shown under the topic What's New when All is clicked, " +   homeSteps.getResult() );
	//	Reporter.writeSummary("TCID_HOME_057,  Verify whether Content Bundle Course Video and Learning path are shown  under What's New when All link is clicked, " +   homeSteps.getResult() );
