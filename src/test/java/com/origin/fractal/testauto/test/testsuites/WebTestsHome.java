...
//		 new Object[] { "4", "ie11" }
	...
	public void testHomePage(String row, String strBrowserName) {
      ...
      //TCID_33:The coverage percentage is shown with the text Coverage
		...
		//TCID_41: Verify Continue Text are displayed	    homeSteps.verifyContinueText();//newui
...
*/		//TCID_80:Verify the function of  Wish list icon
  ...
  //	Reporter.writeSummary("TCID_HOME_055, Checking whether two catalog items displayed in whats new section matches with the first 2 items in the popular content section, " +   homeSteps.getResult() );
		/****till here**/
