	...
	public boolean verifyFilterType(String objPath1, String objpath2, String expType) {
		...
		public boolean verifyFilterTypeRcntAdded(String objPath1, String objpath2, String expType) {
			...
			for(int i=1;i<count-1;i++) {
				wholeObjPath = objPath1+"["+i+objpath2;print("Eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");wait(5);print("wholeObjPath: \n"+wholeObjPath+"\n"+getText(By.xpath(wholeObjPath)));
