...
private By catalogName = By.xpath("//span[@class='three-line-clamp fontz-siz']");//div/ng-include/*//div/span[contains(text(),'Updated on')]/../div/h3
private By catalogType = By.xpath(".//p[@class='cname item-name']");//div/ng-include/*//div/span[contains(text(),'Updated on')]/../p
...
private By catalogValidity = By.xpath("//span[@class='fdcolor pl-1']");//div/ng-include/div/*//div/span[contains(text(),'Valid till:')]/span
...
//********************added 08/04/2019****************//
public String getGobal(String str) {
String propKey = pageName + "_" + str;
String lblValue = FractalUtils.getProperty(propKey);
return lblValue;
}
//********************here************************//
